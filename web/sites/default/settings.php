 ...
 * @endcode
 */
$settings['hash_salt'] = 'h0fzMeZpYOzCqECnCf6gU3um55twQq-scOGlHGwVopEtyA_vBWxx4wYkHeKAK4RSCYC2kmXT0w';
...
if (isset($env['CONFIG_SYNC']) && $env['CONFIG_SYNC'] === 'PROD') {
  $config['config_split.config_split.hml']['status']= FALSE;
}
else if(isset($env['CONFIG_SYNC']) && $env['CONFIG_SYNC'] === 'HML') {
